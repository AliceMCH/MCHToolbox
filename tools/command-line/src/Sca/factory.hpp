...
#include "hdlc_core.hpp"
  ...
  #include "cern/cru.hpp"
  #include "cern/hdlc_cern_me.hpp"
#endif
...
#elif defined BUILD_FOR_CRU
    static constexpr const char* id = "02:00.0";
    static constexpr const char* id_help = "(PCI BDF notation, e.g. 02:00.0, or card serial number [CRU])";
    static constexpr uint32_t bar = 2; //2;
#endif
};
