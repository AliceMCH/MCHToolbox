...
FecRevision::rev_map_ = {
  ...
  //
  {0x28ec, std::make_tuple(0x853, REV_1A, SAMPA_REV_4)}, // Next batch from ORNL, 18th Oct2018
  {0x28a8, std::make_tuple(0x858, REV_1A, SAMPA_REV_4)},
  {0x2854, std::make_tuple(0x857, REV_1A, SAMPA_REV_4)},
  {0x286e, std::make_tuple(0x839, REV_1A, SAMPA_REV_4)},
  {0x2881, std::make_tuple(0x838, REV_1A, SAMPA_REV_4)},
  // Dummy tuple
