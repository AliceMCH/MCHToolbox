...
struct FecDefaults
{
  uint32_t scacfg_basic_crb_{0xfc/*0x9c*/};            /**< Configuration for GBT-SCA register CRB */
  uint32_t scacfg_basic_crc_{0x0f/*0x0f*/};            /**< Configuration for GBT-SCA register CRC */
  uint32_t scacfg_basic_crd_{0x10};            /**< Configuration for GBT-SCA register CRD */
  uint32_t scacfg_gpio_direction_{0xffffffff/*0xffc003ff*/}; /**< GPIO pin direction: All output, except for board Id*/
  uint32_t scacfg_gpio_dataout_{0x2/*0x29800140*/};   /**< GPIO data out values */
};
