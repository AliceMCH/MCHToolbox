...
export PATT_PHYS_SYNC=0x3F0FC3F0FC3F0FC3F0FC
export PATT_HBTR_SYNC=0x0FC3F0FC3F0FC3F0FC3F
export PATT_PHYS_HBTR_SYNC=0x3FCFF3FCFF3FCFF3FCFF
...
echo "export PATT_PHYS_SYNC=${PATT_PHYS_SYNC}" >> ${ENVFILE}
echo "export PATT_HBTR_SYNC=${PATT_HBTR_SYNC}" >> ${ENVFILE}
echo "export PATT_PHYS_HBTR_SYNC=${PATT_PHYS_HBTR_SYNC}" >> ${ENVFILE}
